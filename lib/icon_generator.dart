...
Icon generateIcon(String title) {
  ...
  } else if (title.contains("commute") || title.contains("drive") || title.contains("travel") || title.contains("train") || title.contains("bus")) {
    return Icon(Icons.drive_eta);
  } else if (title.contains("relax") || title.contains("chill")) {
    return Icon(Icons.weekend);
  } else if (title.contains("study") || title.contains("lecture") || title.contains("school") || title.contains("read") || title.contains("research") || title.contains("revise") || title.contains("revision")) {
  ...
  } else if (title.contains("music") || title.contains("concert") || title.contains("gig") || title.contains("song")) {
    return Icon(Icons.music_note);
  } else if (title.contains("write")) {
    return Icon(Icons.edit);
  } else if (title.contains("party") || title.contains("friend") || title.contains("meet")) {
    return Icon(Icons.people);
  } else if (title.contains("sleep") || title.contains("bed") || title.contains("nap") || title.contains("rest")) {
    return Icon(Icons.hotel);
  } else if (title.contains("store") || title.contains("shopping") || title.contains("shop")) {
    return Icon(Icons.store);
  } else if (title.contains("morning") || title.contains("beach") || title.contains("park") || title.contains("wake up") || title.contains("walk") || title.contains("garden")) {
    return Icon(Icons.wb_sunny);
  } else if (title.contains("work") || title.contains("meeting") || title.contains("assignment") || title.contains("project")) {
